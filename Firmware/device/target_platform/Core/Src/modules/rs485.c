...
static rs485_register_t rx_register = {.buffer = {0, 0, 0},
                                       .packet = {.sync_byte = 0, .cmd_byte = 0, .data_byte = 0}};
...
static rs485_register_t tx_register = {
    ...
    .packet = {.sync_byte = RS485_SYNC_BYTE, .cmd_byte = 0, .data_byte = 0}};

/// @brief rs485 context mainly used for the uart handle.
static rs485_ctx_t ctx = {.huart = NULL, .tx_timeout = HAL_MAX_DELAY};
